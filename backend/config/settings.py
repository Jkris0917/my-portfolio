...
SECRET_KEY = os.getenv('SECRET_KEY','django-insecure-nvb15we^a89p!og@(^1i1-d4qn0z5^#+(=*obzzb6q$i35vb@&')
...
# CONTACT_NOTIFICATION_EMAIL = os.getenv('EMAIL_HOST_USER')
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')
DEFAULT_FROM_EMAIL = os.getenv('EMAIL_HOST_USER', 'portfolio@johnkris.dev')
CONTACT_NOTIFICATION_EMAIL = os.getenv('EMAIL_HOST_USER', 'gelladojohnkris@gmail.com')